...
* Debe tener acceso a una cuenta de usuario con el nivel de acceso necesario
* Entre los detalles de la cuenta se incluye el nombre de usuario y la contraseña
* Requisitos del puerto: 443
* Permisos de cuenta:
+
** Funcionalmente, Cloud Insights realiza solicitudes de lectura, pero se requieren algunos permisos de escritura para que la infraestructura convergente se registre en la cabina ONTAP. Consulte la nota sobre los permisos a continuación.
