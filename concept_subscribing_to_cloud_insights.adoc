...
La seguridad de la carga de trabajo se mide en función de si los nodos utilizados son de gama alta, media o básica, en los siguientes recuentos de unidades gestionadas (MU):

|===


| Tipo de nodo: | Modelos de ejemplo: | Medido a: 


| 1 Nodo de gama alta | 700 de febrero de 800, 900 9xxx | 80 Unidades gestionadas 


| 1 Nodo de gama media | 300, 400, 500, 8x00 | 40 Unidades gestionadas 


| 1 Nodo de gama básica | 1xx, 2xx, 2xxx | 20 Unidades gestionadas 


| 1 ONTAP de software | CVO, FSx | 10 Unidades gestionadas 


| 1 Nodo desconocido |  | 80 Unidades gestionadas 
|===
