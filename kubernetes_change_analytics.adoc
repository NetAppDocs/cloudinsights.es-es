...
* En entornos multi-tenant, las interrupciones del servicio pueden ocurrir debido a cambios mal configurados. En entornos muy dinámicos, es posible que Cloud Insights Change Analytics no pueda realizar un seguimiento adecuado de todos los cambios.
