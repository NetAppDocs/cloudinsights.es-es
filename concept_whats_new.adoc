...
=== Latencia de volumen de iSCSI

Las métricas de latencia de volumen iSCSI están disponibles para usar en consolas, alertas, etc. Para recopilar métricas de latencia iSCSI, active _Network Performance and Map_ en el elemento de menú Modificar implementación de Kubernetes Collector.
