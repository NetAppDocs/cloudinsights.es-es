...
* Lista blanca *Tipos de archivos permitidos*: Si se detecta un ataque de ransomware para una extensión de archivo conocida, esa extensión de archivo se puede incluir en la lista blanca para evitar alertas innecesarias. - link:/ws_allowed_file_types.html["Leer más"]
