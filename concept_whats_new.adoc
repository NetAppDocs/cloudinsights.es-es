...
Cloud Insights ahora puede crear informes sobre todos los datos de Kubernetes, incluidos los volúmenes fotovoltaicos, la RVP, la carga de trabajo, el clúster y el espacio de nombres.
