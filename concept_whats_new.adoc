...
Usted nos pidió que le proporcionaran valores de suma de comprobación durante la instalación del agente para Windows, Linux y MacOS, y creemos que esa es una gran idea. Así que aquí están:
