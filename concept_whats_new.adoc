...
En Seguridad de carga de trabajo, puede pausar un recopilador de datos si el recopilador está en estado _Running_ o _Error_. Abra el menú de tres puntos para el recopilador y seleccione PAUSE. Mientras el recopilador está en pausa, no se recopilan datos desde ONTAP y no se envía ningún dato del recopilador a ONTAP. Seleccione Reanudar para comenzar a recopilar de nuevo.
