...
* Entorno Oracle link:TBD["ajustes de configuración"] se guardan en un único archivo de configuración autodocumentado.
...
=== Informar de los datos de VP de Kubernetes

La información sobre el volumen persistente (PV) de Kubernetes recopilada por Cloud Insights ahora se puede usar en informes, lo que permite el pago por uso, las tendencias, la previsión, los cálculos de TTF, Y otros informes empresariales sobre métricas para clústeres de Kubernetes, espacios de nombres, cargas de trabajo, etc.
...
5d6a6764c313767cd859950497830f19
...
* https://[] (Nota: Tendrá que iniciar sesión en el soporte de NetApp).
* https://[]
