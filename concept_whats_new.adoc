...
El componente de informes de Cloud Insights se ha cambiado de nombre a «Análisis de Cloud Insights». Sin embargo, no se preocupe; la funcionalidad sigue siendo la misma.
