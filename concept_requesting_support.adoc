...
NOTE: Debe registrarse para poder <<activating-support-entitlement,active el soporte>> Para productos de cloud de NetApp. Para registrarse, visite el sitio de NetApp link:https://register.netapp.com["Registro de soporte de servicios de datos en el cloud"].
...
Puede ver o descargar información y detalles sobre recopiladores de datos compatibles en la link:reference_data_collector_support_matrix.html["*Matriz de compatibilidad con recopiladores de datos Cloud Insights*, role="external""].
