...
. En el menú Workload Security (Seguridad de carga de trabajo), haga clic en: *Admin > colectores de datos > colectores de directorios de usuarios > + colector de directorio de usuario* y seleccione *Active Directory*
+
