...
Consulte la documentación de OnCommand Cloud Volumes ONTAP para configurar una instancia AWS de nodo único / alta disponibilidad para alojar el agente de Cloud Secure:https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/index.html[]
...
En AWS, siga estos pasos para configurar el equipo que se usará como agente de Cloud Secure:
