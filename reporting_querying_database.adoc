...
NOTE: Esta documentación hace referencia a la función de generación de informes de Cloud Insights, que está disponible en la edición premium de Cloud Insights.
