...
Tenga en cuenta que los tipos de API a los que tiene acceso un usuario también dependen de link:concept_user_roles.html["Rol de usuario"] Estas incluyen en cada conjunto de funciones de Cloud Insights (Supervisión, Cloud Secure, Informes).
