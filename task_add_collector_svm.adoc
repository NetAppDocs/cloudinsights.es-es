...
** Protocolo NFS versión 4.1 y anteriores
...
* • El almacén persistente de ONTAP es compatible con 9.15.1.
...
* No se puede suprimir un recopilador de datos en pausa.
* Mientras está en pausa, la configuración de fpolicy en ONTAP está deshabilitada, pero no se elimina. Al reanudar, se vuelven a habilitar los ajustes de fpolicy en ONTAP.
