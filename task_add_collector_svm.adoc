...
** Protocolo SMB, versión 3.1 y versiones anteriores. Tenga en cuenta que Cloud Secure no funciona con configuraciones de SMB que utilizan FlexCache. A partir de ONTAP9.7, Fpolicy solo se admite en entornos NFS.
