...
[]
====
Permisos para la integración ARP de ONTAP:
...
....
Permisos para Acceso ONTAP Denegado:

....
security login rest-role create -role csrestrole -api /api/protocols/fpolicy -access all -vserver <cluster_name>
security login create -user-or-group-name csuser -application http -authmethod password -role csrestrole
....
Nota: Si ya se ha agregado un rol REST--ya sea _arwrole_ o _csrestrole_- no es necesario agregar un segundo rol REST. Simplemente puede agregar los permisos de la API como en el ejemplo siguiente.

Ejemplo: _Csrestrole_ ya está presente, por lo que solo tenemos que habilitar la protección anti-ransomware y dar permisos API al _csrestrole_ existente:
...
....
>>>>>>> b8087143154c7dd9f5d1d3f33ee1bbdf97a7c9d1
=== Permisos para la protección autónoma contra ransomware de ONTAP
