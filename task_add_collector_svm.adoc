...
* Mientras está en pausa, la configuración de fpolicy en ONTAP está deshabilitada, pero no se elimina. Al reanudar, la configuración de fpolicy en ONTAP se vuelve a activar.
