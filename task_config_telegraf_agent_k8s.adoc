...
| Los eventos de My kubernetes dejaron de generar informes inesperadamente para Cloud Insights. | Recupere el nombre del pod `kubectl -n netapp-monitoring get pods 


| exportador de eventos grep | awk '{print $1}' 
|===
